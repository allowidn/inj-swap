...
class Logger:
    @staticmethod
    def info(msg):
        console.print(f"[bold {THEME['primary']}]•[/] {msg}")
    
    @staticmethod
    def warn(msg):
        console.print(f"[bold {THEME['warning']}]![/] [bold]{THEME['warning']}]Warning:[/] {msg}")
    
    @staticmethod
    def error(msg):
        console.print(f"[bold {THEME['error']}]✗[/] [bold]{THEME['error']}]Error:[/] {msg}")
    
    @staticmethod
    def success(msg):
        console.print(f"[bold {THEME['success']}]✓[/] [bold]{THEME['success']}]Success:[/] {msg}")
    
    @staticmethod
    def loading(msg):
        console.print(f"[bold {THEME['info']}]⟳[/] {THEME['info']}{msg}")
    
    @staticmethod
    def step(msg):
        console.print(f"[bold {THEME['accent']}]→[/] [bold]{msg}[/bold]")
